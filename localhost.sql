...
-- 資料庫: `expstore`
-- 
CREATE DATABASE `expstore` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `expstore`;
...
-- 資料庫: `lincan`
-- 
CREATE DATABASE `lincan` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `lincan`;
...
CREATE TABLE `feedback` (
  `id` int(11) NOT NULL auto_increment COMMENT '使用者訊息流水號',
...
INSERT INTO `feedback` VALUES (1, '測試中文姓名1', '測試電話1', '測試email 1', '測試地址', 'this is a test message blah blah blah', '2024-07-08 13:27:25');
INSERT INTO `feedback` VALUES (2, 'test_name中文測試', 'test_tel', 'test_email@xxx.com', 'test_address', '測試訊息', '2024-07-11 10:59:53');
-- 
-- 資料庫: `mysql`
-- 
...
INSERT INTO `user` VALUES (0x6c6f63616c686f7374, 0x726f6f74, 0x2a36424234383337454237343332393130354545343536384444413744433637454432434132414439, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0);
...
INSERT INTO `user` VALUES (0x6c6f63616c686f7374, 0x73616c6573, 0x2a36424234383337454237343332393130354545343536384444413744433637454432434132414439, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0);
-- 
-- 資料庫: `news`
-- 
...
-- 
-- 列出以下資料庫的數據： `newsadmin`
-- 

INSERT INTO `newsadmin` VALUES ('123456', '123456');
INSERT INTO `newsadmin` VALUES ('654321', '654321');
...
CREATE TABLE `newscenter` (
  ...
  `news_type` varchar(10) collate utf8_unicode_ci NOT NULL,
  `news_date` date NOT NULL,
  `news_subject` varchar(100) collate utf8_unicode_ci NOT NULL,
  `news_content` text collate utf8_unicode_ci,
  `news_editor` varchar(10) collate utf8_unicode_ci NOT NULL,
  `news_ok` enum('Yes','No') collate utf8_unicode_ci NOT NULL default 'Yes',
  `news_hits` smallint(5) unsigned NOT NULL default '0',
  `appendix` varchar(100) collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`news_id`)
...
INSERT INTO `newscenter` VALUES (1, '新聞', '2016-10-14', '苗栗最高齡(109歲)~就在苑裡鎮', '苑裡鎮長杜文卿今天上午帶領公所服務團隊，親赴本鎮也是全苗栗縣最高齡人瑞(109歲)黃郭蝦ㄚ嬤府上，並致贈慰問金6千元，祝福ㄚ嬤重陽佳節快樂！', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (2, '活動', '2016-08-30', '11月份家犬(貓)結紮&狂犬病疫苗注射及晶片植入', '105年11月份苑裡鎮免費家犬(貓)結紮&狂犬病疫苗注射及晶片植入活動報名開始。', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (3, '公告', '2016-10-21', '地景保育認知教育研習', '苗栗縣政府-本府為推廣地景保育認知，訂於105年11月18日至19日(星期五、六)辦理教育研習會', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (4, '活動', '2016-10-13', '苗栗縣2016士子開中門活動', ' 苗栗縣政府辦理「苗栗縣2016士子開中門」活動', '民政課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (5, '活動', '2016-10-12', '臺灣宗教百景達人大挑戰」活動', '為向全民介紹與推廣此一實用便利的工具，特於105年10月5日至10月24日舉行「臺灣宗教百景達人大挑戰」線上活動，參加者於活動網站答對10道題目，可參加第一階段抽獎', '民政課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (6, '公告', '2016-10-03', '2016臺灣地質攝影比賽', '經濟部中央地質調查所-本所舉辦「2016臺灣地質攝影比賽─地質路上我和你」活動', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (7, '公告', '2016-10-10', '水林番薯公主的音樂饗宴', '雲林縣水林鄉公所-本鄉辦理「2016水林番薯公主的音樂饗宴&2016第五屆全國烏克麗麗嘉年華」推廣活動   ', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (8, '活動', '2016-02-24', '2016苑裡閩客慶元宵', '本鎮105年度「2016苑裡閩客慶元宵」活動2月20日(星期六)下午18時30分於本鎮致民國中學生禮堂熱烈開演，現場除發放摸彩券、提供1,000份元宵提燈供民眾索取', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (9, '新聞', '2016-05-10', '苑裡鎮105年模範母親代表表揚活動', '苑裡鎮105年度模範母親代表表揚活動，於105年5月7日(星期六)在漁香園港式曙U舉辦，鎮長頒發每位模範母親賀匾表揚', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (10, '活動', '2016-04-18', '苑裡鎮105年模範母親代表芳名錄', '本所訂於105年5月7日(星期六)於本鎮漁香園港式曙U辦理「苑裡鎮105年度模範母親代表表揚活動」', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (11, '公告', '2016-10-29', '105年度水稻及各種農作物化學肥料補助計畫', '苑裡鎮農會辦理105年度水稻及各種農作物化學肥料補助計畫,每包補助30元整,總補助經費60萬元整,本會自7/1起起開始辦理補助,至補助經費用完為止.', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (12, '活動', '2016-09-27', '本土語言嬝玩擘s-『大家來講地方話', '苗栗縣立圖書館105年「本土語言嬝玩擘s-『大家來講地方話』，詳細資訊請參考公佈欄', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (13, '活動', '2017-06-21', '中華民國自然生態保育協會辦理2017年全國生物多樣性教育培訓', '培訓班訂7月28日至7月31日及8月11日至8月14日，假行政院農業委員會特有生物研究中心舉辦，有意參予民眾，請逕至該協會網站(http://www.swan.org.tw)下載相關表單報名。', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (14, '新聞', '2017-05-18', '106年度『免費狂犬病疫苗注射及晶片植入』活動圓滿結束', '106年度『免費狂犬病疫苗注射及晶片植入』活動於106年5月8日至5月18日下鄉辦理共計10場次，狂犬病疫苗注射169隻犬（貓），晶片植入77隻犬（貓），活動圓滿完成', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (15, '新聞', '2017-10-16', '發放106年度第4季社會救助米共1,350公斤', '鎮長杜文卿要求公所團隊每季主動向中央爭取社會救助米，此次發放予低收、中低收入戶，預估受益戶數達270戶。所發送之救助白米都是提領日由碾米廠新碾製的新鮮白米，載運回來後立即由各里幹事發送到家，用心看得見新鮮有保障。', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (16, '公告', '2018-01-11', '公告「富邦產物水稻區域收穫農作物保險」', '行政院農業委員會公告「富邦產物水稻區域收穫農作物保險」為農委會補助農民投保之農作物天然災害保險商品。', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (17, '活動', '2018-01-11', '107年「免費家犬（貓）結紮&免費狂犬病疫苗注射活動」。 ', '為減少本鎮流浪犬（貓）數量並嘉惠地方，本所協同湖光動物醫院及台灣之心愛護動物協會辦理「免費家犬（貓）結紮服務活動」，同時函請苗栗縣動物保護防疫所下鄉協助辦理「免費狂犬病疫苗注射及晶片植入活動」，日期為 107年 5 月 6日', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (18, '活動', '2017-11-09', '107年度苑裡鎮南勢林段地籍圖重測作業宣導', '107年度苑裡鎮南勢林段地籍圖重測作業宣導，茲訂於106年12月1日上午10時於苑裡鎮南勢里社區活動中心，舉辦地籍圖重測作業宣導會，惠請相關土地所有權人準時與會', '民政課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (19, '活動', '2017-08-23', '苗栗縣政府名人小客廳講座-8月27日作家褚士瑩主講', '教育部青年發展署與本府合辦之名人小客廳講座，8月27日下午2時將邀請知名作家褚士瑩先生主講「在西拉雅呼喊全世界：褚士瑩的發現之旅」', '社會課', 'Yes', 0, '名人小客廳講座.pdf');
INSERT INTO `newscenter` VALUES (20, '活動', '2017-09-19', '協助公告教育部青年發展署-2017全球青年趨勢論壇 ', '教育部青年發展 署於 106106106年 10 月 28 日至 29 日辦理「 2017201720172017全球青年趨勢論壇 全球青年趨勢論壇 全球青年趨勢論壇 -永續 發展倡議 」， 活動 一同與來自各國 的青年 朋友討論 朋友討論 交流。', '社會課', 'Yes', 0, '2017全球青年趨勢論壇報名簡章.pdf');
INSERT INTO `newscenter` VALUES (21, '公告', '2018-01-09', ' 行政院農業委員會自107年起推動「對地綠色環境給付計畫」。 ', '為有效調整稻作產業結構，擴大鼓勵轉(契)作種植具競爭力作物，並結合公糧稻蔚O價收購與稻作直接給付併行制度，本會自107年起推動「對地綠色環境給付計畫」', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (22, '活動', '2018-10-09', '107年度結合統一發票推行辦理租稅網路推廣活動計畫辦理', '活動日期自即日起至107年11月30日止，請上該活動頁面（網址：https://mlftax.ntbca.tw/', '財政課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (23, '新聞', '2018-07-19', '苑裡鎮107年度模範父親芳名錄', '本所訂於107年8月4日(六)上午9時30分御廚曙U舉辦「苑裡鎮107年度模範父親代表表揚活動」', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (24, '新聞', '2018-06-15', '各界捐贈陳O蘭女士善款一覽表', '有關媒體報載本鎮「一碗麵」的故事，各界善心捐款踴躍，（詳如捐贈ㄧ覽表），善款共計新台幣79,500元（截至107年6月15日止），本所已全數親交陳?蘭女士點收無誤', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (25, '活動', '2019-10-25', '發放108年度第4季社會救助米共960公斤', '自鎮長劉秋東上任以來，要求公所團隊主動爭取社會救助米，十分重視弱勢族群。救助白米都是碾米廠碾壓完成，即由清潔隊載運至公所，並委由各里里幹事親自發送到家。此次發放對象為兒少扶助及特境扶助家庭，預估受益戶數達192戶', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (26, '活動', '2019-09-11', '9/14(六)經典小鎮免費公車接駁停駛公告', '適逢中秋連假，本次9/14(星期六)經典小鎮免費公車接駁停駛乙次，祝大家中秋佳節愉快。', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (27, '公告', '2019-12-10', '109年「稻米達人冠軍賽」實施計畫說明書。', '109年「臺灣稻米達人冠軍賽」實施計畫說明書.pdf', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (28, '公告', '2019-12-16', '彰化縣秀水鄉公所辦理「秀水好Young~發現幸福－金陵花海祭」', '請參鴃u彰化縣秀水鄉公所函.pdf」', '農業課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (29, '公告', '2019-12-09', '竹東鎮公所辦理「109年第56屆臺灣客家山歌比賽」相關資訊', '請參鴃u新竹縣竹東鎮公所函.pdf」', '圖書館', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (30, '公告', '2019-12-05', '「一○九年苗栗美展」雙年展，徵件時間自109年1月15日至31日止', '請參鴃u一○九年苗栗美展-簡章內頁.pdf」', '社會課', 'Yes', 0, NULL);
INSERT INTO `newscenter` VALUES (31, '公告', '2019-12-05', '國家圖書館辦理108年臺灣嬝疙`系列活動', '108年台灣嬝疙`活動網站：http://trf2019.ncl.edu.tw/', '', '', 0, NULL);
INSERT INTO `newscenter` VALUES (32, '新聞', '2020-01-21', '【苑裡鎮109年度「寒冬送暖．歲末關懷」活動】新聞稿', '「寒冬送暖．歲末關懷」活動於109年1月20日(星期一)下午1時，由苑裡鎮公所服務團隊5組「愛心送到家」服務專車，將各界捐贈物資發送至本鎮182戶列冊低收入戶家中，讓各低收入戶在寒冬中感受到關懷與溫暖。', '', '', 0, NULL);
INSERT INTO `newscenter` VALUES (33, '活動', '2020-10-16', '轉知國家檔案管理局2020檔案月「檔案•有憶事」', '2020檔案月活動「檔案•有憶事」於11月隆重登場，串聯全國各機關、學校及藝文場館推出各式檔案推廣活動，邀請您一起翻噢?v軌跡、玩轉檔案現場，參加活動可抽Airpods、電影票等精彩好禮，相關活動訊息請見官網「檔案月─全國檔案憶事堂」', '', '', 0, NULL);
INSERT INTO `newscenter` VALUES (34, '公告', '2021-01-05', '行政院農業委員會農糧署110年「對地綠色環境給付計畫」內容重點單張。', '請參?10年「對地綠色環境給付計畫」內容重點.pdf', '', '', 0, NULL);
INSERT INTO `newscenter` VALUES (35, '活動', '2020-07-14', '苑裡鎮109年鎮長盃球類競賽活動', '比賽時間：109年8月22日、23日(星期六、日)上午8時起，比賽地點：苑裡鎮立體育場、縣立苑裡高級中學、苑裡國小、國立苑裡高級中學(雨備)', '', '', 0, NULL);
-- 
-- 資料庫: `pharmacy`
-- 
CREATE DATABASE `pharmacy` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `pharmacy`;
...
INSERT INTO `addbook` VALUES (3, 1, 9, '林小強', '0912345678', '407', '工業區一路100號', '2021-04-22 10:39:50');
INSERT INTO `addbook` VALUES (4, 0, 10, '李小明', '0934567891', '105', '中正路1號', '2021-04-22 10:41:48');
INSERT INTO `addbook` VALUES (8, 0, 10, '陳小信', '0934567891', '223', '中正路1號', '2021-04-22 10:41:48');
INSERT INTO `addbook` VALUES (9, 0, 10, '曹小成', '0934567891', '290', '中正路1號', '2021-04-22 10:41:48');
INSERT INTO `addbook` VALUES (10, 1, 10, '張山山', '0934567891', '407', '工業區一路100號', '2021-04-23 20:00:59');
...
INSERT INTO `carousel` VALUES (1, '雙11正式開跑 SOFINA全館5折起 - SOFINA 限時特惠', 'SOFINA iP限定組合下殺39折起，加碼再送『iP美容液30g』，全館滿額再享現金回饋。[雙11正式開跑]SOFINA 全年最低價，全館最低5折起。', 1, 1, 'pic0.jpg', 13, '2021-03-18 11:59:55');
INSERT INTO `carousel` VALUES (2, '建康養生的好幫手', '華陀扶元堂養生飲品系列3折優惠，歡迎選購', 1, 2, 'pic2.jpg', 49, '2021-03-18 11:59:55');
INSERT INTO `carousel` VALUES (3, '頂級保濕面膜，臉部滋養的好幫手', 'My Beauty Diary熱銷7款面膜特價優惠，歡迎選購', 1, 3, 'pic3.jpg', 50, '2021-03-18 11:59:55');
INSERT INTO `carousel` VALUES (4, '慶祝媽媽節特惠方案', '為感恩全天下辛苦的母親節特別推出一系列優惠專案', 1, 4, 'pic1.jpg', 51, '2021-03-18 11:59:55');
...
INSERT INTO `cart` VALUES (66, 10, 42, 3, '1619161669175448', 1, '::1', '2021-04-23 15:06:48');
INSERT INTO `cart` VALUES (67, 10, 43, 3, '1619161669175448', 1, '::1', '2021-04-23 15:06:54');
INSERT INTO `cart` VALUES (68, 10, 15, 13, '1619161669175448', 1, '::1', '2021-04-23 15:07:03');
INSERT INTO `cart` VALUES (69, 10, 27, 2, '1619161669175448', 1, '::1', '2021-04-23 15:07:15');
INSERT INTO `cart` VALUES (70, 10, 51, 1, '1619161734581887', 1, '::1', '2021-04-23 15:08:16');
INSERT INTO `cart` VALUES (71, 10, 47, 1, '1619161734581887', 1, '::1', '2021-04-23 15:08:20');
INSERT INTO `cart` VALUES (72, 10, 46, 1, '1619161734581887', 1, '::1', '2021-04-23 15:08:24');
INSERT INTO `cart` VALUES (74, 10, 27, 1, '1619181180278775', 1, '::1', '2021-04-23 15:22:31');
INSERT INTO `cart` VALUES (76, 10, 26, 1, '1619181180278775', 1, '::1', '2021-04-23 15:22:38');
INSERT INTO `cart` VALUES (78, 10, 51, 1, '1619260500232495', 1, '::1', '2021-04-23 20:39:53');
INSERT INTO `cart` VALUES (79, 10, 28, 2, '1619260500232495', 1, '::1', '2021-04-23 20:39:56');
INSERT INTO `cart` VALUES (80, 10, 25, 3, '1619260500232495', 1, '::1', '2021-04-23 20:39:59');
INSERT INTO `cart` VALUES (81, 10, 21, 1, '1619260500232495', 1, '::1', '2021-04-23 20:40:03');
INSERT INTO `cart` VALUES (82, 10, 48, 1, '1619261102143533', 1, '::1', '2021-04-24 18:43:59');
INSERT INTO `cart` VALUES (83, 10, 47, 1, '1619261102143533', 1, '::1', '2021-04-24 18:44:02');
INSERT INTO `cart` VALUES (84, 10, 46, 1, '1619261102143533', 1, '::1', '2021-04-24 18:44:04');
INSERT INTO `cart` VALUES (86, 10, 45, 1, '1619261102143533', 1, '::1', '2021-04-24 18:44:12');
INSERT INTO `cart` VALUES (87, 10, 20, 1, '1619261102143533', 1, '::1', '2021-04-24 18:44:20');
INSERT INTO `cart` VALUES (88, 10, 19, 1, '1619261102143533', 1, '::1', '2021-04-24 18:44:25');
INSERT INTO `cart` VALUES (89, 10, 50, 1, '1619261151557635', 1, '::1', '2021-04-24 18:45:29');
...
INSERT INTO `hot` VALUES (1, 13, 1);
INSERT INTO `hot` VALUES (2, 14, 2);
INSERT INTO `hot` VALUES (3, 15, 3);
...
INSERT INTO `member` VALUES (9, 'test@gmail.com', '123456', 1, '林小強', 'A123456789', '2021-04-01', '', '2021-04-22 10:39:50');
INSERT INTO `member` VALUES (10, 'te@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 1, '李小明', 'A223456789', '2021-04-01', '', '2021-04-22 10:41:48');
...
INSERT INTO `product_img` VALUES (4, 13, 'zoom-back-175065.webp', 1, '2021-03-10 14:36:26');
INSERT INTO `product_img` VALUES (5, 13, 'zoom-front-175065.webp', 2, '2021-03-10 14:36:26');
INSERT INTO `product_img` VALUES (6, 13, 'zoom-side-175065.webp', 3, '2021-03-10 14:37:23');
INSERT INTO `product_img` VALUES (7, 14, '-Touch-in-SOL-32g-2001472.webp', 2, '2021-03-10 14:37:23');
INSERT INTO `product_img` VALUES (8, 14, '-Touch-in-SOL-32g-2001471.webp', 1, '2021-03-10 14:37:23');
INSERT INTO `product_img` VALUES (9, 14, '-Touch-in-SOL-32g-2001473.webp', 3, '2021-03-10 14:37:23');
INSERT INTO `product_img` VALUES (10, 15, 'zoom-front-202291.webp', 1, '2021-03-10 15:16:13');
INSERT INTO `product_img` VALUES (11, 15, 'zoom-front-202292.webp', 2, '2021-03-10 15:16:13');
INSERT INTO `product_img` VALUES (12, 16, '-UV-30ml-SPF50-PA-177591.webp', 1, '2021-03-10 15:20:07');
INSERT INTO `product_img` VALUES (13, 16, '-UV-30ml-SPF50-PA-177592.webp', 2, '2021-03-10 15:20:07');
INSERT INTO `product_img` VALUES (14, 17, 'zoom2555551.webp', 1, '2021-03-10 15:20:07');
INSERT INTO `product_img` VALUES (15, 17, 'zoom2555552.webp', 2, '2021-03-10 15:20:07');
INSERT INTO `product_img` VALUES (16, 17, 'zoom2555553.webp', 3, '2021-03-10 15:20:07');
INSERT INTO `product_img` VALUES (18, 18, 'NARUKO-SPF3025g-1777891.jpg', 1, '2021-03-17 11:06:03');
INSERT INTO `product_img` VALUES (19, 18, 'NARUKO-SPF3025g-1777892.jpg', 2, '2021-03-17 11:06:03');
INSERT INTO `product_img` VALUES (20, 18, 'NARUKO-SPF3025g-177789.webp', 3, '2021-03-17 11:06:03');
INSERT INTO `product_img` VALUES (21, 19, '-SUNPLAY-35g-1943271.webp', 1, '2021-03-17 11:09:50');
INSERT INTO `product_img` VALUES (22, 19, '-SUNPLAY-35g-1943272.webp', 2, '2021-03-17 11:09:50');
INSERT INTO `product_img` VALUES (23, 20, 'zoom-front-2076081.webp', 1, '2021-03-17 11:16:12');
INSERT INTO `product_img` VALUES (24, 20, 'zoom-back-2076082.webp', 2, '2021-03-17 11:16:12');
INSERT INTO `product_img` VALUES (25, 20, 'zoom-swatch-2076083.webp', 3, '2021-03-17 11:16:12');
INSERT INTO `product_img` VALUES (26, 21, 'zoom-front-2021801.webp', 1, '2021-03-17 11:33:26');
INSERT INTO `product_img` VALUES (27, 21, 'zoom-side-2021802.webp', 2, '2021-03-17 11:33:26');
INSERT INTO `product_img` VALUES (28, 21, 'zoom-back-2021803.webp', 3, '2021-03-17 11:33:26');
INSERT INTO `product_img` VALUES (29, 22, 'zoom-front-1935161.webp', 1, '2021-03-17 11:37:56');
INSERT INTO `product_img` VALUES (30, 22, 'zoom-side-1935162.webp', 2, '2021-03-17 11:37:56');
INSERT INTO `product_img` VALUES (31, 22, 'zoom-back-1935163.webp', 3, '2021-03-17 11:37:56');
INSERT INTO `product_img` VALUES (32, 22, 'zoom-swatch-1935164.webp', 4, '2021-03-17 11:37:56');
INSERT INTO `product_img` VALUES (33, 23, 'zoom-front-1390401.webp', 1, '2021-03-17 11:43:06');
INSERT INTO `product_img` VALUES (34, 23, 'zoom-side-1390402.webp', 2, '2021-03-17 11:43:06');
INSERT INTO `product_img` VALUES (35, 23, 'zoom-back-1390403.webp', 3, '2021-03-17 11:43:06');
INSERT INTO `product_img` VALUES (36, 24, '-SPF50-50ml-196690.webp', 1, '2021-03-17 11:46:20');
INSERT INTO `product_img` VALUES (37, 24, '-SPF50-50ml-1966902.webp', 2, '2021-03-17 11:46:20');
INSERT INTO `product_img` VALUES (38, 25, 'zoom-front-2221811.webp', 1, '2021-03-17 11:51:23');
INSERT INTO `product_img` VALUES (39, 25, 'zoom-side-2221812.webp', 2, '2021-03-17 11:51:23');
INSERT INTO `product_img` VALUES (40, 25, 'zoom-back-222183.webp', 3, '2021-03-17 11:51:23');
INSERT INTO `product_img` VALUES (41, 26, 'zoom-front-5737981.webp', 1, '2021-03-17 11:54:24');
INSERT INTO `product_img` VALUES (42, 26, 'zoom-side-5737982.webp', 2, '2021-03-17 11:54:24');
INSERT INTO `product_img` VALUES (43, 26, 'zoom-back-5737983.webp', 3, '2021-03-17 11:54:24');
INSERT INTO `product_img` VALUES (44, 27, 'zoom-front-2093981.webp', 1, '2021-03-17 11:57:51');
INSERT INTO `product_img` VALUES (45, 27, 'zoom-side-2093982.webp', 2, '2021-03-17 11:57:51');
INSERT INTO `product_img` VALUES (46, 27, 'zoom-side-2093983.webp', 3, '2021-03-17 11:57:51');
INSERT INTO `product_img` VALUES (47, 28, 'zoom-front-2077811.webp', 1, '2021-03-17 14:16:58');
INSERT INTO `product_img` VALUES (48, 28, 'zoom-back-2077812.webp', 2, '2021-03-17 14:16:58');
INSERT INTO `product_img` VALUES (49, 29, 'DHC-B-90-1492921.webp', 1, '2021-03-17 14:31:25');
INSERT INTO `product_img` VALUES (50, 29, 'DHC-B-90-1492922.webp', 2, '2021-03-17 14:31:25');
INSERT INTO `product_img` VALUES (51, 30, 'zoom-front-1821751.webp', 1, '2021-03-17 14:37:21');
INSERT INTO `product_img` VALUES (52, 30, 'zoom-side-1821752.webp', 2, '2021-03-17 14:37:21');
INSERT INTO `product_img` VALUES (53, 30, 'zoom-back-1821753.webp', 3, '2021-03-17 14:37:21');
INSERT INTO `product_img` VALUES (54, 31, 'burner-EX-PLUS-40-1977821.webp', 1, '2021-03-17 14:40:31');
INSERT INTO `product_img` VALUES (55, 31, 'burner-EX-PLUS-40-1977822.webp', 2, '2021-03-17 14:40:31');
INSERT INTO `product_img` VALUES (56, 32, '-VAGI-Guard-X5-60-1282971.webp', 1, '2021-03-17 15:18:43');
INSERT INTO `product_img` VALUES (57, 32, 'prd-back-1282972.webp', 2, '2021-03-17 15:18:43');
INSERT INTO `product_img` VALUES (58, 33, 'zoom-front-1658561.webp', 1, '2021-03-17 15:23:13');
INSERT INTO `product_img` VALUES (59, 33, 'zoom-back-1658562.webp', 2, '2021-03-17 15:23:13');
INSERT INTO `product_img` VALUES (60, 34, 'NOW-100-9555351.webp', 1, '2021-03-17 15:27:12');
INSERT INTO `product_img` VALUES (61, 34, '-100-9555352.webp', 2, '2021-03-17 15:27:12');
INSERT INTO `product_img` VALUES (62, 34, 'NOW-100-9555353.webp', 3, '2021-03-17 15:27:12');
INSERT INTO `product_img` VALUES (63, 34, '-100-9555354.jpg', 4, '2021-03-17 15:27:12');
INSERT INTO `product_img` VALUES (64, 35, 'Sundown-800mcg-100-1330211.webp', 1, '2021-03-17 15:29:45');
INSERT INTO `product_img` VALUES (65, 35, 'Sundown-800mcg-100-1330212.webp', 2, '2021-03-17 15:29:45');
INSERT INTO `product_img` VALUES (66, 36, 'zoom-front-1821471.webp', 1, '2021-03-17 15:32:38');
INSERT INTO `product_img` VALUES (67, 36, 'zoom-side-1821472.webp', 2, '2021-03-17 15:32:38');
INSERT INTO `product_img` VALUES (68, 36, 'zoom-back-1821473.webp', 3, '2021-03-17 15:32:38');
INSERT INTO `product_img` VALUES (69, 37, 'zoom-front-1882881.webp', 1, '2021-03-17 15:35:19');
INSERT INTO `product_img` VALUES (70, 37, 'zoom-back-1882882.webp', 2, '2021-03-17 15:35:19');
INSERT INTO `product_img` VALUES (71, 38, 'zoom-front-1026621.webp', 1, '2021-03-17 15:40:00');
INSERT INTO `product_img` VALUES (72, 38, 'zoom-front-1026621.webp', 2, '2021-03-17 15:40:00');
INSERT INTO `product_img` VALUES (73, 38, 'zoom-back-1026623.webp', 3, '2021-03-17 15:40:00');
INSERT INTO `product_img` VALUES (74, 39, 'zoom-front-1630531.webp', 1, '2021-03-17 15:51:51');
INSERT INTO `product_img` VALUES (75, 39, 'zoom-back-1630532.webp', 2, '2021-03-17 15:51:51');
INSERT INTO `product_img` VALUES (76, 40, 'zoom-front-1821491.webp', 1, '2021-03-17 15:55:25');
INSERT INTO `product_img` VALUES (77, 40, 'zoom-side-1821492.webp', 2, '2021-03-17 15:55:25');
INSERT INTO `product_img` VALUES (78, 40, 'zoom-back-1821493.webp', 3, '2021-03-17 15:55:25');
INSERT INTO `product_img` VALUES (79, 41, 'zoom-front-2013591.webp', 1, '2021-03-17 15:58:31');
INSERT INTO `product_img` VALUES (80, 41, '202005290952594629052.webp', 2, '2021-03-17 15:58:31');
INSERT INTO `product_img` VALUES (81, 42, 'zoom-front-1400311.webp', 1, '2021-03-17 16:02:39');
INSERT INTO `product_img` VALUES (82, 42, 'zoom-back-1400312.webp', 2, '2021-03-17 16:02:39');
INSERT INTO `product_img` VALUES (83, 43, 'zoom-front-1821591.webp', 1, '2021-03-17 16:06:00');
INSERT INTO `product_img` VALUES (84, 43, 'zoom-side-1821592.webp', 2, '2021-03-17 16:06:00');
INSERT INTO `product_img` VALUES (85, 43, 'zoom-back-1821593.webp', 3, '2021-03-17 16:06:00');
INSERT INTO `product_img` VALUES (86, 44, '201710261231438624291.webp', 3, '2021-03-17 16:15:22');
INSERT INTO `product_img` VALUES (87, 44, '-BestVite-1-60-1042581.webp', 1, '2021-03-17 16:17:40');
INSERT INTO `product_img` VALUES (88, 44, '-BestVite-1-60-1042582.webp', 2, '2021-03-17 16:17:40');
INSERT INTO `product_img` VALUES (89, 45, '-Acnes-BB-30g-5337271.webp', 1, '2021-03-17 16:27:09');
INSERT INTO `product_img` VALUES (90, 45, '-Acnes-BB-30g-533727.webp', 2, '2021-03-17 16:27:09');
INSERT INTO `product_img` VALUES (91, 46, 'divinia-3D-CC-SPF50-50g-247262.webp', 1, '2021-03-17 16:38:37');
INSERT INTO `product_img` VALUES (92, 46, '247262-2.jpg', 2, '2021-03-17 16:38:37');
INSERT INTO `product_img` VALUES (93, 47, 'zoom-back-159935.webp', 1, '2021-03-17 16:42:31');
INSERT INTO `product_img` VALUES (94, 47, 'zoom-back-159935.webp', 2, '2021-03-17 16:42:31');
INSERT INTO `product_img` VALUES (95, 48, 'zoom-front-174388.webp', 1, '2021-03-17 16:50:05');
INSERT INTO `product_img` VALUES (96, 48, 'zoom-side-174388.webp', 2, '2021-03-17 16:50:05');
INSERT INTO `product_img` VALUES (97, 48, 'zoom-swatch-174388.webp', 3, '2021-03-17 16:50:05');
INSERT INTO `product_img` VALUES (98, 49, 'zoom-front-171339.webp', 1, '2021-03-18 11:21:43');
INSERT INTO `product_img` VALUES (99, 49, 'zoom-back-171339.webp', 2, '2021-03-18 11:21:43');
INSERT INTO `product_img` VALUES (100, 50, '-10-182065.webp', 1, '2021-03-18 11:29:09');
INSERT INTO `product_img` VALUES (101, 50, '-10-1820652.webp', 2, '2021-03-18 11:29:09');
INSERT INTO `product_img` VALUES (102, 51, 'zoom-front-186053.webp', 1, '2021-03-18 11:35:17');
INSERT INTO `product_img` VALUES (103, 51, 'zoom-back-186053.jpg', 2, '2021-03-18 11:35:17');
INSERT INTO `product_img` VALUES (104, 52, 'KARADIUM-01.jpg', 1, '2024-07-29 16:14:45');
INSERT INTO `product_img` VALUES (105, 52, 'KARADIUM-02.jpg', 2, '2024-07-29 16:15:52');
INSERT INTO `product_img` VALUES (106, 52, 'KARADIUM-03.jpg', 3, '2024-07-29 16:16:05');
...
CREATE TABLE `pyclass` (
  ...
  `create_date` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT '建立時間與更新時間',
  PRIMARY KEY  (`classid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT AUTO_INCREMENT=120 ;

-- 
-- 列出以下資料庫的數據： `pyclass`
-- 

INSERT INTO `pyclass` VALUES (1, 1, 'fa-paw', '彩妝專區', 1, 0, '2021-03-10 11:24:20');
INSERT INTO `pyclass` VALUES (2, 1, 'fa-user', '臉部保養', 2, 0, '2021-03-10 11:24:36');
INSERT INTO `pyclass` VALUES (3, 1, 'fa-desktop', '美膚保養', 3, 0, '2021-03-10 11:25:13');
INSERT INTO `pyclass` VALUES (21, 2, 'fa-file', '隔離/防曬/飾底乳', 1, 1, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (22, 2, 'fa-file', 'BB霜/CC霜', 2, 1, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (23, 2, 'fa-file', '粉餅(蕊)/蜜粉/蜜粉/海綿', 3, 1, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (24, 2, 'fa-file', '遮瑕/毛孔/打亮', 4, 1, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (25, 2, 'fa-file', '天然成分調理專區', 1, 2, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (26, 2, 'fa-file', '婦嬰,敏感受損調理', 2, 2, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (27, 2, 'fa-file', 'Neogen', 3, 2, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (28, 2, 'fa-file', '萊雅', 4, 2, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (29, 2, 'fa-file', '肌研', 5, 2, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (110, 2, 'fa-file', '露得清', 6, 2, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (111, 2, 'fa-file', '基礎保養／芝麻素', 1, 3, '2021-03-17 14:27:31');
INSERT INTO `pyclass` VALUES (112, 2, 'fa-file', '益生菌／乳酸菌', 2, 3, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (113, 2, 'fa-file', '鐵／葉酸／孕期補充', 3, 3, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (114, 2, 'fa-file', '蔓越莓／女性保養', 4, 3, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (115, 2, 'fa-file', '男性健康補充', 5, 3, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (116, 2, 'fa-file', '銀髮健康補充', 6, 3, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (117, 2, 'fa-file', '成人特殊營養品', 7, 3, '2021-03-10 11:23:46');
INSERT INTO `pyclass` VALUES (118, 1, 'fa-desktop', '化妝品-好吃', 4, 0, '2024-07-22 13:56:26');
INSERT INTO `pyclass` VALUES (119, 2, 'fa-file', '眉筆/眉粉/染眉膏', 1, 118, '2024-07-15 16:23:52');
...
INSERT INTO `uorder` VALUES ('1619161669175448', 10, 4, 3, 35, 7, NULL, '2021-04-23 15:07:49');
INSERT INTO `uorder` VALUES ('1619161734581887', 10, 4, 3, 35, 7, NULL, '2021-04-23 15:08:54');
INSERT INTO `uorder` VALUES ('1619181180278775', 10, 9, 3, 35, 7, NULL, '2021-04-23 20:33:00');
INSERT INTO `uorder` VALUES ('1619260500232495', 10, 4, 3, 35, 7, NULL, '2021-04-24 18:35:00');
INSERT INTO `uorder` VALUES ('1619261102143533', 10, 4, 3, 35, 7, NULL, '2021-04-24 18:45:02');
INSERT INTO `uorder` VALUES ('1619261151557635', 10, 10, 3, 35, 7, NULL, '2021-04-24 18:45:51');
INSERT INTO `uorder` VALUES ('1662031788775169', 10, 11, 3, 35, 7, NULL, '2022-09-01 19:29:48');
-- 
-- 資料庫: `phpmyadmin`
-- 
...
-- 
-- 列出以下資料庫的數據： `pma_table_info`
-- 

-- 
-- 資料庫: `student`
-- 
CREATE DATABASE `student` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `student`;
...
CREATE TABLE `stud` (
  `stud_id` tinyint(5) unsigned NOT NULL auto_increment,
  `stud_name` varchar(100) collate utf8_unicode_ci NOT NULL,
  `stud_idno` varchar(100) collate utf8_unicode_ci NOT NULL,
  `stud_sex` varchar(100) collate utf8_unicode_ci NOT NULL,
  `stud_birthday` date NOT NULL,
  `stud_school` varchar(100) collate utf8_unicode_ci NOT NULL,
  `stud_major` varchar(100) collate utf8_unicode_ci NOT NULL,
  `stud_phone` varchar(100) collate utf8_unicode_ci default NULL,
  `stud_address` varchar(100) collate utf8_unicode_ci NOT NULL,
  `stud_photo` varchar(100) collate utf8_unicode_ci NOT NULL,
  `stud_hits` smallint(6) NOT NULL default '0',
  `stud_appendix` varchar(100) collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`stud_id`)
...
INSERT INTO `stud` VALUES (1, '林啟芳', 'P122340348', 'F', '1981-01-28', '中央大學', '數學系', '0932895113', '臺中縣大里市永興路3巷21號', '', 0, NULL);
INSERT INTO `stud` VALUES (2, '顏志全', 'P122709413', 'M', '1980-03-12', '東海大學', '經濟系', '0928950442', '雲林縣北港鎮公園路205巷43號', '顏志全.jpg', 0, '簡歷表(顏志全).pdf');
INSERT INTO `stud` VALUES (3, '林正裕', 'P120859329', 'M', '1965-01-04', '臺灣工業技術學院', '工業管理技術系', '0921663180', '臺中市西區居仁街385號11樓', '林正裕.jpg', 0, NULL);
INSERT INTO `stud` VALUES (4, '蔣春芳', 'B220287447', 'F', '1975-10-02', '東海大學', '統計系', '0989892992', '臺中縣太平市仁和街360號4樓', '蔣春芳.jpg', 0, NULL);
INSERT INTO `stud` VALUES (5, '蔡惠佑', 'E120005418', 'M', '1970-07-20', '義守大學', '資管所', '0925103089', '高雄市三民區明誠一路21號12樓', '蔡惠佑.jpg', 0, NULL);
INSERT INTO `stud` VALUES (6, '張巍立', 'R123457926', 'M', '1983-10-18', '嘉義大學', '畜產系', '0980816993', '臺中市南區五權南路78巷3-5號', '張巍立.jpg', 0, NULL);
INSERT INTO `stud` VALUES (7, '楊雅蕙', 'I200161771', 'F', '1987-10-10', '中國醫藥大學', '生物醫學影像暨放射科學系', '0932628865', '臺中市西區華美街132巷2號', '楊雅蕙.jpg', 0, NULL);
INSERT INTO `stud` VALUES (8, '陳炫開', 'N125076512', 'M', '1988-10-21', '淡江大學', '土木工程設施組', '0937305710', '彰化縣永靖鄉中山路2段28巷127號', '陳炫開.jpg', 0, NULL);
INSERT INTO `stud` VALUES (9, '陳家貴', 'L122320554', 'M', '1976-10-12', '臺中技術學院附設專科進修學校', '商業文書科', '0912325387', '臺中縣清水鎮西社里中華路123號', '陳家貴.jpg', 0, NULL);
INSERT INTO `stud` VALUES (10, '唐婉玲', 'B221929271', 'F', '1981-01-20', '嘉義大學', '初等教育系', '0910692449', '臺中市北屯區陳平路215巷16號', '唐婉玲.jpg', 0, NULL);
INSERT INTO `stud` VALUES (11, '楊育仁', 'B1220343772', 'M', '1984-12-10', '中原大學', '資訊工程系', '0932643820', '臺中市西區長春街125號7樓', '楊育仁.jpg', 0, NULL);
INSERT INTO `stud` VALUES (12, '王宥茹', 'L220876301', 'F', '1970-12-12', '嶺東科技大學', '應用外語系', '0963430103', '臺中縣梧棲鎮永興路2段321巷35號', '王宥茹.jpg', 0, NULL);
INSERT INTO `stud` VALUES (13, '賴嘉彬', 'B120385652', 'M', '1957-11-13', '臺中二中', '普通科', '0923987490', '臺中市西區日新街132號2樓', '賴嘉彬.jpg', 0, NULL);
INSERT INTO `stud` VALUES (14, '景建德', 'J122005207', 'M', '1980-11-14', '萬能技術學院', '電子工程系', '0933261832', '新竹縣芎林鄉文山路142巷6弄19號', '景建德.jpg', 0, NULL);
INSERT INTO `stud` VALUES (15, '葉祖德', 'S124835830', 'M', '1970-11-12', '東方工業專科學校', '電子工程科', '0931893432', '高雄縣大寮鄉琉球村黃厝路324-16號', '葉祖德.jpg', 0, NULL);
INSERT INTO `stud` VALUES (16, '蘇鵬煌', 'L124121802', 'M', '1986-11-24', ' 大葉大學', '資訊工程系', '0921207893', '臺中縣沙鹿鎮鹿峰里中山路田尾巷321號', '蘇鵬煌.jpg', 0, NULL);
INSERT INTO `stud` VALUES (17, '詹詠蘭', 'A228982290', 'F', '1992-12-29', '勤益科技大學', '工業工程與管理系', '0973135902', '臺中市西屯區臺中港路3段115巷9號', '詹詠蘭.jpg', 0, NULL);
INSERT INTO `stud` VALUES (18, '曾寶方', 'T220990880', 'F', '1961-11-10', '東海大學', '經濟系', '0937240302', '臺中市西區大仁街156號6樓-2', '曾寶方.jpg', 0, NULL);
INSERT INTO `stud` VALUES (19, '吳秀芳', 'Q220878561', 'F', '1969-08-15', '國防醫學院', '護理系', '0933645663', '高雄市鼓山區美術東四街18號2樓', '吳秀芳.jpg', 0, NULL);
INSERT INTO `stud` VALUES (20, '邱清西', 'B120035113', 'M', '1970-09-15', '臺中高工', '汽修科', '09331145361', '臺中市西區民生路120號', '邱清西.jpg', 0, NULL);
INSERT INTO `stud` VALUES (21, '郭耀慶', 'A124367778', 'M', '1977-05-03', '中國工商專校', '建築科', '0937012440', '臺中縣太平市中山路1段12-15號7樓', '郭耀慶.jpg', 0, NULL);
INSERT INTO `stud` VALUES (22, '張祐輝', 'I100008781', 'M', '1983-07-21', '高苑技術學院', '土木工程系', '0916111985', '嘉義市上海路22號5樓-3', '張祐輝.jpg', 0, NULL);
INSERT INTO `stud` VALUES (23, '楊麗雯', 'G220342451', 'F', '1967-06-21', '德明商專', '國貿科', '0916502449', '臺中市南屯區大業路431號3樓-1', '楊麗雯.jpg', 0, NULL);
INSERT INTO `stud` VALUES (24, '郭乃祐', 'B121239650', 'M', '1973-04-21', '勤益技術學院', '電子工程系', '0918070771', '臺中市北區學士路231巷1-5號', '郭乃祐.jpg', 0, NULL);
INSERT INTO `stud` VALUES (25, '周玉鈴', 'C220678371', 'F', '1965-12-11', '臺北商業技術學院附設空專', '資訊管理科', '0983650120', '臺中縣太平市新仁路1路134巷11弄14號', '周玉鈴.jpg', 0, NULL);
...
-- 
-- 列出以下資料庫的數據： `studadmin`
-- 

INSERT INTO `studadmin` VALUES ('123456', '123456');
INSERT INTO `studadmin` VALUES ('654321', '654321');
-- 
-- 資料庫: `test`
-- 
